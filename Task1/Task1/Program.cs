...
namespace Task1
{
    public class Program
    {
        public static void Main()
        {
            ...
            TeamService barselonaServices = new TeamService(bars, fw);
            ...
            fw.WriteLine("Игроки старше 30 лет:");
            ...
            TeamService realServices = new TeamService(real, fw);
            ...
            GameService FIFA1service = new GameService(FIFA1, fw);
